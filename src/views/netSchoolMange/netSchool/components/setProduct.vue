<template>
  <div>
    <div class="ta-l"><span>商品列表</span></div>
    <div class="ta-l">
      <div>
    ...
    <div class="ta-l flex row jc-sb mt-05">
      <span class="tx-008 tx-wb txc-60">最多显示数量</span>
      <el-input
        size="small "
    ...
    >
      <!-- <div class="flex row ai-c">
        <img class="w-6 h-4" :src="item.url" />
        <div class="ml-02">
          <el-input
            size="small "
            v-model="item.title"
      ...
      <div class="mt-05 flex row ai-c">
        ...
        <div class="pd-1" @click="deleteItem(value, item)">
...
export default {
  ...
  methods: {
    ...
    selectedProduct(products, columnData, productData, selectedType) {
      ...
      this.value.divDatas.push(product);
