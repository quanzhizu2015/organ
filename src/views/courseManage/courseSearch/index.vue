<template>
  <section class="courseSchedul_border">
    <div class="header">
      ...
      >
        <template slot-scope="scope">
          ...
          <!-- <el-button
            ...
            @click="addCourse(0, {}, new Date(), new Date())"
            >增加课时</el-button
          > -->
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          ...
          <!-- <el-button
            ...
            @click="addCourse(1, {}, new Date(), new Date())"
            >增加课时</el-button
          > -->
        </template>
      </el-table-column>
    ...
    <el-table
      :data="weekDays2"
      v-if="
        isWeekEdit > 0 && isReadyShe && isInMonth(weekHeaderData2[0]['date'])
          ? true
          : false
      "
      highlight-current-row
      ...
      >
        <template slot-scope="scope">
          ...
          <!-- <el-button
            ...
            @click="addCourse(2, {}, new Date(), new Date())"
            >增加课时</el-button
          > -->
        </template>
      </el-table-column>
    ...
    <el-table
      :data="weekDays3"
      v-if="
        isWeekEdit > 0 && isReadyShe && isInMonth(weekHeaderData3[0]['date'])
          ? true
          : false
      "
      highlight-current-row
      ...
      >
        <template slot-scope="scope">
          ...
          <!-- <el-button
            ...
            @click="addCourse(3, {}, new Date(), new Date())"
            >增加课时</el-button
          > -->
        </template>
      </el-table-column>
    ...
    <el-table
      :data="weekDays4"
      v-if="
        isWeekEdit > 0 && isReadyShe && isInMonth(weekHeaderData4[0]['date'])
          ? true
          : false
      "
      highlight-current-row
      ...
      >
        <template slot-scope="scope">
          ...
          <!-- <el-button
            ...
            @click="addCourse(4, {}, new Date(), new Date())"
            >增加课时</el-button
          > -->
        </template>
      </el-table-column>
    ...
    <el-table
      :data="weekDays5"
      v-if="
        isWeekEdit > 0 && isReadyShe && isInMonth(weekHeaderData5[0]['date'])
          ? true
          : false
      "
      highlight-current-row
      ...
      >
        <template slot-scope="scope">
          ...
          <!-- <el-button
            ...
            @click="addCourse(5, {}, new Date(), new Date())"
            >增加课时</el-button
          > -->
        </template>
      </el-table-column>
    ...
    <!--工具条-->
    <!-- <div class="header" v-if="isReadyShe">
...
export default {
  ...
  methods: {
    ...
    getWeekDay() {
      ...
      //this.addCourse(0, {}, new Date(), new Date());

      this.weekDays1 = new Array();
      //this.addCourse(1, {}, new Date(), new Date());

      this.weekDays2 = new Array();
      //this.addCourse(2, {}, new Date(), new Date());

      this.weekDays3 = new Array();
      //this.addCourse(3, {}, new Date(), new Date());

      this.weekDays4 = new Array();
      //this.addCourse(4, {}, new Date(), new Date());

      this.weekDays5 = new Array();
      //this.addCourse(5, {}, new Date(), new Date());
    ...
    fixWeekData(week, node) {
      ...
      if (weekDays.length > node) {
        ...
        this.addCourse(week, {}, new Date(), new Date());
...
<style>
.courseSchedul_border .el-table__header tr,
.el-table__header th {
  padding: 0;
  height: 40px;
}

.courseSchedul_border .el-date-editor .el-range-input {
  width: 40px;
}

.courseSchedul_border .el-date-editor .el-range-separator {
  width: 20px;
}
</style>
